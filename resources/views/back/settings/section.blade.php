					...
					<div class="row">
                        <div class="col-xl-3 col-lg-3">
                            <div class="nav flex-column m-3 theme_change nav-pills nav-secondary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                {{-- <a class="nav-link" data="theme1" data-toggle="pill" href="#hone">{{ __('Home One') }}</a> --}}
                                <a class="nav-link active" data="theme2" data-toggle="pill" href="#htwo">{{ __('Home Sections Manage') }}</a>
                                ...
                                @include('alerts.alerts')
                                    ...
                                    <div id="tabs">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="htwo" class="tab-pane active"><br>
