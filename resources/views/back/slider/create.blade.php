                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="nav nav-pills nav-secondary" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                  <a class="nav-link active" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">{{ __('Home Banner Slider') }}</a>
                                </li>
                                {{-- <li class="nav-item">
