          ...
          <div class="col-lg-3 order-lg-1">
            ...
            <aside class="sidebar sidebar-offcanvas position-left"><span class="sidebar-close"><i class="icon-x"></i></span>
              ...
              <section class="widget widget-categories card rounded p-4">
                ...
                <form class="price-range-slider" method="post" data-start-min="{{request()->input('minPrice') ? request()->input('minPrice') : '0'}}" data-start-max="{{request()->input('maxPrice') ? request()->input('maxPrice') : '500000'}}" data-min="0" data-max="500000" data-step="5000">
