        ...
        <div class="col-md-8">
              ...
              <div class="single-review">
                  <div class="comment">
                    ...
                    <div class="comment-author-ava"><img class="lazy" data-src="{{asset('assets/images/'.$review->user->photo)}}" alt="{{$review->user->first_name}}"></div>
                    @else
                    <div class="comment-author-ava"><img class="lazy" data-src="https://image.pngaaa.com/209/4803209-middle.png" alt="{{$review->user->first_name}}"></div>
                    @endif
                    <div class="comment-body">
                      <div class="comment-header d-flex flex-wrap justify-content-between">
                        <div>
                            <h4 class="comment-title mb-1">{{$review->subject}}</h4>
                            <span><b>{{$review->user->first_name}}</b></span>
                            <span class="ml-3"> <small><i> on {{$review->created_at->format('M d, Y')}} </i></small> </span>
                        </div>
                        <div class="mb-2">
