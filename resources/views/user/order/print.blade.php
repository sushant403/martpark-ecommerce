        ...
        <div class="card card-body p-5">
            <div class="row">
                <div class="col text-center">
                  ...
                  <!-- Logo -->
                  <img class="img-fluid mb-5" width="170"  alt="Logo" src="{{asset('assets/images/'.$setting->logo)}}">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered my-4">
                      ...
                      <tr>
                          ...
                          <td class=" text-right">
                            @if ($setting->currency_direction == 1)
                            {{$order->currency_sign}}{{number_format(round($item['main_price']*$order->currency_value,2))}}  
                            @else
                            {{number_format(round($item['main_price']*$order->currency_value,2))}}{{$order->currency_sign}}
                            @endif
